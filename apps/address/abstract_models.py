...
class AbstractAddress(models.Model):
    ...
    """
    ACCRA, KUMASI, TEMA, KOFORIDUA, CAPECOAST, TAKORADI, SUNYANI, TAMALE, HO, BOLGATANGA, WA = ('Accra', 'Kumasi', 'Tema', 'Koforidua', 'Cape-Coast', 'Takoradi', 'Sunyani', 'Tamale', 'Ho', 'Bolgatanga', 'Wa',)
    MR, MR, MISS, MRS, MS, DR = ('Mr', 'Miss', 'Mrs', 'Ms', 'Dr')
    ...
    CITY_CHOICES = (
        ...
        (KUMASI, _("Kumasi")),
        (TEMA, _("Tema")),
        (KOFORIDUA, _("Koforidua")),
        (CAPECOAST, _("Cape-Coast")),
        (TAKORADI, _("Takoradi")),
        (SUNYANI, _("Sunyani")),
        (TAMALE, _("Tamale")),
        (HO, _("Ho")),
        (BOLGATANGA, _("Bolgatanga")),
        (WA, _("Wa")),
    )   
    ...
    line2 = models.CharField(
        ...
        help_text=_("In case we dont catch with you at first address"))
